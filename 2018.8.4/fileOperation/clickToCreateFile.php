<?php
	...
	/*Finally taking the php array or the obj and again converting it to json obj in php*/
	...
	/*now we write into a .json file all the data we fetched*/
	
	$handle = fopen('output1.json','w');
	fwrite($handle,$encode1);
	$handle = fopen('output2.json','w');
	fwrite($handle,$encode2);
